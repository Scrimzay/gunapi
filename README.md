the worlds best gun api for gun ehthusiasts. its very simple, creates a sqlite3 db (db included in repo), adds info the db, then makes db calls based on the endpoint visited. very simple and cool.
